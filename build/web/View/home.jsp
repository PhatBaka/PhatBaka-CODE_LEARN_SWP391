...
#paging
{
    ...
    left: 44%;
        ...
        <div class="container px-4" id="course">
          <div class="row gx-5"style="width:125%;">
            <div class="col" >
             <div class="p-3 border bg-light">Course 1</div>
            </div>
            <div class="col">
              <div class="p-3 border bg-light">Course 2</div>
            </div>
            <div class="col">
              <div class="p-3 border bg-light">Course 3</div>
            </div>
          </div>
        </div>
