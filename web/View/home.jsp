                ...
                <nav class="navbar navbar-expand-lg bg-light" id="background">
                    ...
                    <div class="container-fluid">
                        <span class="navbar-brand" href="#" style="cursor:pointer;">
                            <div class="dropdown">
                                <a href="MainController?action=Noti"> <ion-icon name="notifications-outline"></ion-icon></a> 
                                        <% List<ExamDTO> list = (List<ExamDTO>) request.getAttribute("listP");
                                      //      if (list != null) {
                                      //           if (!list.isEmpty()) {
                                        %>
